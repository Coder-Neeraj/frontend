                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    <div className="flex flex-col items-center ">
                        ...
                        <div className="flex flex-wrap space-x-5 justify-center">
                            {product.images.map((item) => <div className='aspect-h-2 aspect-w-3 overfloe-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-4'>
                                <img
                                    alt={item.alt}
                                    src={item.src}
                    ...
                    lg:pb-24">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                           ...
                           <div className='flex space-x-5 items-center text-xl text-gray-900 mt-6'> 
                  ...
                  <p className='text-green-600 font-semibold '>5% off</p>
                        ...
                        <p className='opacity-50 text-sm'>23435 Ratings</p> 
                        <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>3445 Reviews</p>
                        </div>  
...
{[1,1,1,1].map((item)=> <ProductReviewCard/> )}
 ...
 <div className='flex items-center space-x-3'>
  ...
  <p className='opacity-60'>89389 Ratings</p>
 </div> 
...
<section className='pt-10'>
 ...
 <div className='flex flex-wrap font-bold space-y-5'>
